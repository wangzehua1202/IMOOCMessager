...
import com.xingsu.italker.factory.model.db.GroupMember;
...
public class DbHelper {
    ...
    //观察者集合，Class<?>观察的表， Set<ChangedListener>每一个表对应的观察者有很多
    private final Map<Class<?>, Set<ChangedListener>> changedListeners = new HashMap<>();

    /**
     * 从所有的监听者中，获取一个表的监听者
     * @param modelClass 表对应的信息
     * @param <Model> 泛型
