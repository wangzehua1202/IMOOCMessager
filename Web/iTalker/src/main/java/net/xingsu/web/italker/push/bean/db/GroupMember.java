 ...
 */
@Entity
@Table(name = "TB_GROUP_FOLLOW")
public class GroupMember {
    public static final int PERMISSION_TYPE_NONE = 0;//普通成员，默认级别
    public static final int PERMISSION_TYPE_ADMIN = 1;//管理级别
    public static final int PERMISSION_TYPE_ADMIN_SU = 100;//创建者

    public static final int NOTIFY_LEVEL_INVALID = -1;//不接收
    public static final int NOTIFY_LEVEL_NONE = 0;//接收，默认级别
    public static final int NOTIFY_LEVEL_CLOSE = 1;//接收不提醒
