...
import net.xingsu.web.italker.push.utils.PushDispatcher;
...
//        dispatcher.submit();
     ...
     */
    @GET
    @Path("{id}")//path //127.0.0.1/api/user/{id}
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    ...
    //为了简化分页，只返回20条数据
    @GET
    //path //127.0.0.1/api/user/search/
